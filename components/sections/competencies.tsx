const competencies = [
  {
    ...
    description: 'Siswa dilatih berpikir kritis, meneliti, dan menemukan solusi dari tantangan dunia nyata.',
  },
  {
    number: '02',
    icon: 'people',
    ...
    description: 'Siswa belajar bekerja dalam tim, berbagi peran, dan mencapai hasil terbaik bersama.',
  },
  {
    number: '03',
    icon: 'mic',
    ...
    description: 'Siswa terlatih menyampaikan ide secara jelas, meyakinkan, dan profesional.',
  },
  {
    number: '04',
    icon: 'lightbulb',
    ...
    description: 'Siswa memahami bisnis dari praktik langsung, dari perencanaan hingga penjualan.',
  },
  {
    number: '05',
    icon: 'palette',
    ...
    description: 'Siswa didorong untuk berpikir kreatif, bereksplorasi, dan menciptakan solusi orisinal.',
  },
  {
    number: '06',
    icon: 'heart',
    ...
    description: 'Pendidikan menyeluruh yang menumbuhkan iman, empati, dan tanggung jawab pada alam dan sesama.',
  },
]
