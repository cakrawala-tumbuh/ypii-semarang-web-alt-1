...
export function PPDB() {
  ...
  return (
    ...
    >
      {/* Decorative Elements */}
      <div
        className="absolute -top-32 -right-32 w-96 h-96 rounded-full border-20 border-[rgba(43,58,30,.1)] pointer-events-none"
      />
      <div
        className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full border-20 border-[rgba(43,58,30,.06)] pointer-events-none"
      />
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-[#2b3a1e] italic mb-8">
          ...
          <div
            id="form-ppdb"
            className="bg-white/60 backdrop-blur-2xl border border-[rgba(43,58,30,.15)] rounded-2xl p-10 lg:sticky lg:top-32"
          >
            <h3 className="text-2xl font-black text-[#2b3a1e] mb-2">Isi Form Pendaftaran</h3>
            <p className="text-sm text-[#2b3a1e]/60 mb-8">Tim kami akan menghubungi dalam 1×24 jam</p>
            ...
            {submitted ? (
              <div className="text-center py-12">
                ...
                <h4 className="text-lg font-bold text-[#2b3a1e] mb-2">Pendaftaran Berhasil!</h4>
                <p className="text-sm text-[#2b3a1e]/60">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label className="block text-sm font-semibold text-[#2b3a1e] mb-2">Nama Anak *</label>
                  <input
                    type="text"
                    name="nama_anak"
                    ...
                    className="w-full bg-white/70 border border-[rgba(43,58,30,.2)] rounded-lg px-4 py-3 text-[#2b3a1e] placeholder-[#2b3a1e]/40 focus:outline-none focus:border-[#9D0A0E] transition-colors"
                  />
                </div>

                <div>
                  <label className="block text-sm font-semibold text-[#2b3a1e] mb-2">Tanggal Lahir Anak *</label>
                  <input
                    type="date"
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#2b3a1e] mb-2">Unit yang dituju *</label>
                  <select
                    name="unit_dituju"
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#2b3a1e] mb-2">Nama Orang Tua Calon Siswa *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#2b3a1e] mb-2">No. WA Orang Tua Siswa *</label>
                  <input
                    type="tel"
